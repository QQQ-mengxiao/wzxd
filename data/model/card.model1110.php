        ...
        if($dbh){
            ...
            switch($type){
                case 'zihpay':
                    $amount = $data_card['amount'];
                    $lastData = $data_card['LastDate'];
                    $amountSql="update HCCardBase set Balance16=Balance16-$amount,LastDate='$lastData' where Sno='$cardno'";
                break;
                case 'refund':
                    $amountSql="update HCCardBase set Balance16=Balance16+".$data_card['amount']." where Sno='$cardno'";
                break;
            }
            ...
            $ConsumeTime = $data_consume['ConsumeTime'];
            $ConsumeAmount = $data_consume['Amount'];
            $consumeSql="insert into HCConsumeExchange select PersonalID,16,'新零售','$ConsumeDate','$ConsumeTime',$ConsumeAmount,Balance16,$ConsumeType,'$orderSno' FROM HCCardBase WHERE Sno='$cardno'";

...
class goodsModel extends Model{
    ...
    //shang商品信息导出用
     ...
     //库存为0商品信息
     public function getGoodsCommonList3($condition, $field = '*', $page = 2000, $order = 'goods_commonid desc') {
        $condition = $this->_getRecursiveClass($condition);
        return $this->table('goods')->field($field)->where($condition)->order($order)->page($page)->select();
    }
    /**
    ...
    public function getGoodsCommonOnlineList2($condition, $field = '*', $page = 2000, $order = "goods_commonid desc") {
     ...
     //商品库存为0
    public function getGoodsCommonOnlineList3($condition, $field = '*', $page = 2000, $order = "goods_commonid desc") {
        $condition['goods_state']   = self::STATE1;
        $condition['goods_verify']  = self::VERIFY1;
     ...
     * @return array
     */
    public function getGoodsOnlineInfoAndPromotionById($goods_id,$member_id) {

...
class specModel extends Model {
	 ...
	 * 规格值列表
	 */
	public function getSpecValueListByClassId($classId) {
		return Model()->table('spec_value')->where(array('gc_id'=>$classId,'store_id'=>4))->field('sp_value_id,sp_value_name')->select();
	}
	/**
	 * 规格值
	 * @param	array	$param 商品资料

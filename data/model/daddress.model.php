...
class daddressModel extends Model {
     ...
     * @param string $order
     */
    public function getAddressList($condition, $fields = '*', $order = '', $limit = '',$page=null) {
        return $this->field($fields)->where($condition)->order($order)->limit($limit)->page($page)->select();
    }
}
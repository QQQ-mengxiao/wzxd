...
class wxsendModel extends Model {
    
    public function __construct() {
        parent::__construct('wxsend');
    }
    
    public function sendMessage($touser, $refund)
    {
        // 一次性订阅消息取货通知模版ID
        ...
        // $access_token='57_J2LEc3z6uUb0L_IX-VdM-HFabtdO-dhmZ4tPo-hPKtOP1-TrdbgeaSeQBwkRlnfivsf8rGGldRN86tR9DLAObJTveUyrsed6ySyKwbtfFNCBMqxs5FGM26UD7Eo_h9McKyuzQATNY7_NwCXvMIRdAEAZVE';
        ...
        //接收者（用户）的 openid
        $data['touser'] = $touser;
          // $data['touser'] =  'o1OXp5R4qZNDRmm-9VThZEEgaLis';
        //所需下发的订阅模板id

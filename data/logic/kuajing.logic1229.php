...
//        $platformNameCiq = '河南中陆进出口贸易有限公司';
		...
		$idType='TOC001';
		$idNumber=$order_list[$order_id]['extend_order_common']['reciver_info']['id_card'];
		...
		$transferType = '5';//$trans_typeArr[0]['code_guan'];

		//运输方式代码（检）  transportationMethod
		$transportationMethod = '5';//$trans_typeArr[0]['code_jian'];
		...
		//运输工具代码（检）  shipCode
		$shipCode = '50';//$trans_toolArr[0]['code_jian'];

		//运输工具名称（检）  shipNameCiq
		$shipNameCiq = '飞机';//$trans_toolArr[0]['tool_name'];

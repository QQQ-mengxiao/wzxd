...
class buy_1Logic {
     ...
     */
    public function getGoodsCartList($cart_list,$rule_id,$member_id) {
     ...
     * @return array
     */
    public function getGoodsOnlineInfo($goods_id,$quantity,$member_id,$rule_id) {
        $goods_info = $this->_getGoodsOnlineInfo($goods_id,$quantity,$member_id);

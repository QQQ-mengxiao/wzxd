...
class buy_1Logic {
     ...
     * @return array
     */
    public function getGoodsOnlineInfo($goods_id,$quantity,$member_id,$time_lag) {
    ...
    public function cardPay($order_list,$input,$buyer_info){
        ...
        foreach($order_list as $order_info){
            ...
            if($available_card_amount>=$order_amount){
                ...
                $orderList['orderAddress'] = unserialize(Model()->table('order_common')->getfby_order_id($order_info['order_id'],'reciver_info'))['address'];
                $goods_list = $model_order->getOrderGoodsList(array('order_id'=>$order_info['order_id']),'goods_id,goods_serial as goodsCode,goods_name as goodsName,goods_price as goodsPrice,goods_num as goodsCount,goods_pay_price as goodsMoney,is_cw');
                $goodsList = [];
                $goods_amount = 0;

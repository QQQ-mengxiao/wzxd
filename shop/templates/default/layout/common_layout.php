    ...
    <div class="head-search-bar">
      ...
      <div class="keyword"><?php echo $lang['hot_search'].$lang['nc_colon'];?>
        <ul>
          ...
          <li><a target="_blank" href="<?php echo urlShop('search', 'index', array('keyword' => $val));?>"><?php echo $val; ?></a></li>
          <?php } }?>
        </ul>
      </div>
...
<!--        <li style="display: none"><a href="http://www.banliego.com/shop/index.php?act=zty&op=D_days#top" --><?php //if($output['index_sign'] == 'zty' && $output['index_sign'] != '0') {echo 'class="current"';} ?><!--国庆·中秋</a></li>-->
      ...
      <!-- <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_doubledan" style="color: red">年终钜惠</a></li> -->
      <!-- <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_nianhuo" style="color: red">年货节</a></li> -->
      <!-- <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_kaichun" style="color: red">开春季</a></li> -->
      <!-- <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_6years" target="_blank" style="color: red">6周年庆</a></li> -->
      <!-- <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_2019718" target="_blank" style="color: red">718周年庆</a></li> -->
       <!-- <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_shuang11" target="_blank" style="color: red">11.11超值购</a></li> -->
         <li><a href="http://www.banliego.com/shop/?act=zty&op=zty_shuangdan" target="_blank" style="color: red">双旦礼遇季</a></li>

...
<div id="vToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
      <a href="#"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/App_download.png" style="bottom: 0px;position: absolute;right: 36px;" nctype="windows_img" id="img"></a>
    <?php if ($_SESSION['is_login']) {?>
    <a href="index.php?act=member&op=home" target="_self">
    <div class="user TA_delay" nctype="a1-barUserInfo">
    ...
    <?php }?>
    <ul class="tools">
     <!-- <li><a href="http://crm2.qq.com/page/portalpage/wpa.php?uin=4006822718&aty=0&a=0&curl=&ty=1" id="chat1_show_user" class="chat TA_delay" target='_blank'><div class="tools_img TA"></div><span class="TA">在线客服</span><i id="new_msg" class="new_msg" style="display:none;"></i></a></li>-->
      <!--<li><a href="http://q.url.cn/s/1nP0tVm" id="chat1_show_user" class="chat TA_delay" target='_blank'><div class="tools_img TA"></div><span class="TA">在线客服</span><i id="new_msg" class="new_msg" style="display:none;"></i></a></li>-->
      <li><a href="http://q.url.cn/s/B96ijym" id="chat1_show_user" class="chat TA_delay" target='_blank'><div class="tools_img TA"></div><span class="TA">在线客服</span><i id="new_msg" class="new_msg" style="display:none;"></i></a></li>
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
	...
	<dl class="invite"><dt><a href="<?php echo BASE_SITE_URL;?>/index.php?act=show_joinin&op=index" target="_blank"><span><b>招商入驻</b></span></a></dt></dl>
	<?php if (C('mobile_isuse') && C('mobile_app')){?>
	<dl class="down_app">
        <dt><em class="ico_tel"></em><a href="http://www.banliego.com/shop/index.php?act=zty&op=app_index">手机移动端</a><i></i></dt>
                <dd>
       <div class="qrcode"><img src="<?php //echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('mobile_app');?><?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.'all_app.png';?>"></div>
        <div class="hint">
          <h4>扫描二维码</h4>
          下载手机客户端</div>
        <div class="addurl">
    ...
    <?php } ?>
	<dl>
        <dt><em class="ico_shop"></em><a href="<?php echo urlShop('seller_login','show_login');?>" title="商家管理">商家管理</a><i></i></dt>
        <dd>
          <ul>
        ...
        <dd>
          <ul>
            <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order&state_type=state_new">待付款订单</a></li>
             <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_order&state_type=state_pay">待发货订单</a></li>

...
<div class="help">
    ...
    <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logowx']; ?>" class="f-l jImg img-error">
        				...
        				<div class="weibo f-l">
        					<div class="ic qq" style="padding-left: 0px; cursor:pointer;" onclick="window.open('http://weibo.com/3826188056/profile?rightmod=1&wvr=6&mod=personinfo');"><?php echo rec(7);?></div>
        					<div class="ic sina" style="padding-left: 0px; cursor:pointer;"><?php echo rec(8);?></div>
        				</div>
        			</div>
    			</div>
    		</div>
...
<div id="footer" class="wrapper">
  ...
  <?php echo html_entity_decode($output['setting_config']['statistics_code'],ENT_QUOTES); ?><br/><a href="http://www.miitbeian.gov.cn" target="_blank"><?php echo $output['setting_config']['icp_number']; ?></a></div>
<?php if (C('debug') == 1){?>

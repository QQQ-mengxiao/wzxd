      ...
      <td><ul class="ncsc-mansong-rule-list">
          ...
          <li>
              <?php echo $lang['level_price'];?><strong><?php echo $val['price'];?></strong>元，&nbsp;
                  ...
                  <?php echo "赠送";?><strong><?php echo $val['count'];?></strong>个
              <?php if(empty($val['goods_id'])) { ?>
                    <!-- <?php echo $lang['gift_name'];?> <span><?php echo $lang['text_not_join'];?></span> -->
              <?php } else { ?>
              		<?php echo "礼品";?><a href="<?php echo $val['goods_url'];?>" title="<?php echo $val['mansong_goods_name'];?>" target="_blank" class="goods-thumb"> <img src="<?php echo cthumb($val['goods_image']);?>"/> </a>
              <?php } ?>
          </li>
          <?php }?>
          <?php }?>

...
<table cellspacing="0" cellpadding="0.5mm" style="table-layout:fixed;">
  ...
  <tr>
    <td height="15mm" width="100mm" align="left" colspan="2"><p style="font-size:36pt;text-align:center;">'.$three_code[$i].'</p></td>
  </tr>
  <tr>
  ...
  <tr class="row5">
    ...
    <td HEIGHT="11mm" width="91mm" align="left" style="font-size:10pt;" >'.$seller_name[$i].'&nbsp;&nbsp;'.$telphone[$i].'<br/>'.$shipper_address[$i].'<br/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="width: 70mm;height: 10mm;border-top: 5px solid black;margin-right: 2mm;font-size: 0">
      <img src="'.$site.'/barcode/test.php?codebar=BCGcode128&text='.$logisticsNo[$i].'" align="right" style="width: 60mm;height: 7mm;">
    </td>

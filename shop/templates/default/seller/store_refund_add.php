  ...
  <div class="ncsc-flow-container">
    ...
    <div class="alert">
      ...
      <ul>
        ...
        <li>4. 成功完成退款/退货；经过商城审核后，会将退款金额退回原来的<em>“支付账户”</em>中）。</li>
      </ul>
    </div>
    <div id="saleRefund" show_id="1">
      
      <div class="ncsc-form-default">
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?act=store_order&op=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
          ...
          <dl>
            ...
            <dd>
              <input type="text" class="text w50" name="refund_amount" value="<?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>" /><em class="add-on"><i class="icon-renminbi"></i></em>（最多 <strong class="green" title="可退金额由系统根据订单商品实际成交额和已退款金额自动计算得出"><?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?></strong> 元） <span class="error"></span>
...
$(function(){
    $('#post_form1').validate({
        ...
        rules : {
            ...
            refund_amount : {
                ...
                number   : true,
                min:0.00,
                max:<?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>
            },
            buyer_message : {
                required   : true
            },
        ...
        messages : {
            ...
            refund_amount  : {
                required  : '<i class="icon-exclamation-sign"></i><?php echo '可退金额';?> <?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>',
                number   : '<i class="icon-exclamation-sign"></i><?php echo $lang['refund_pay_refund'];?> <?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>',
                min   : '<i class="icon-exclamation-sign"></i><?php echo $lang['refund_pay_min'];?> 0.00',
                max   : '<i class="icon-exclamation-sign"></i><?php echo $lang['refund_pay_refund'];?><?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>'
            },
            buyer_message  : {
    ...
    $('#post_form2').validate({
        ...
        messages : {
            ...
            refund_amount  : {
                required  : '<i class="icon-exclamation-sign"></i><?php echo $lang['refund_pay_refund'];?> <?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>',
                number   : '<i class="icon-exclamation-sign"></i><?php echo $lang['refund_pay_refund'];?> <?php echo ncPriceFormat($output['goods']['goods_pay_price']); ?>',

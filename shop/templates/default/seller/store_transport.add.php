  ...
  <div id="dialog_batch" class="dialog-batch" style="z-index: 9999; display:none">
    <div class="ks-contentbox">
      ...
      <form method="post">
        ...
        <!--jinp170608-->
        <input class="w60 text" type="text" maxlength="6" autocomplete="off" value="0.00" name="express_postage_2" data-field="postage"><em class="add-on"> <i class="icon-renminbi"></i> </em>
...
$(function(){
	...
	<?php foreach ($output['extend'] as $value){?>
      ...
      $(cur_tr).find('input[data-field="postage_weight"]').val('<?php echo $value['weight'];?>');
      $(cur_tr).find('input[data-field="postage_money_overweight"]').val('<?php echo $value['money_overweight'];?>');

  ...
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        ...
        <dl>
            <dt><i class="required">*</i><?php echo '商品条码'.$lang['nc_colon'];?></dt>
            <dd>
                <input name="g_barcode" type="text" class="text w210" value="<?php echo $output['goods']['barcode']; ?>" />
                <span></span>
                <p class="hint"><?php echo '商品条码也是商品的唯一标识，望录入时慎重对待';?></p>
            </dd>
        </dl>
      <dl>
    ...
    $('#goods_form').validate({
      ...
      g_deliverdate : {
        ...
        messages : {
            ...
            g_barcode  : {
                required    : '<i class="icon-exclamation-sign"></i><?php echo '商品条码不能为空';?>',
                minlength   : '<i class="icon-exclamation-sign"></i><?php echo '商品条码长度至少10个数字，最长20个数字';?>',
                maxlength   : '<i class="icon-exclamation-sign"></i><?php echo '商品条码长度至少10个数字，最长20个数字';?>'
            },
            g_jingle : {

    ...
    <table class="ncsc-default-table order deliver">
      <tbody>
        ...
        <tr>
          ...
          <td class="bdl bdr order-info w500" rowspan="<?php echo count($output['order_info']['extend_order_goods']);?>" style="padding-bottom: 0px;"><dl>
            ...
            <dl>
              ...
              <dd>
                <textarea name="deliver_explain" cols="100" rows="2" class="w400 tip-t" title="<?php echo $lang['store_deliver_forget_tips'];?>"><?php echo $output['order_info']['extend_order_common']['deliver_explain'];?></textarea>
                  <a onclick="deliver_explainsave();" class="ncsc-btn" style="float: right;"><?php echo '保存';?></a>
              </dd>
            </dl></td>
          <?php }?>
        </tr>
        ...
        <tr>
          ...
          <a href="index.php?act=store_deliver&op=STOPushtest&order_id=<?php echo $output['order_info']['order_id'];?>&op_type=1"   class="ncsc-btn-mini fr"><i class="icon-edit"></i>测试</a>
          <a href="index.php?act=store_deliver&op=STOPrint&order_id=<?php echo $output['order_info']['order_id'].',';?>" target="_blank2" class="ncsc-btn-mini fr"><i class="icon-print"></i>打印（申通）</a>
          <a href="javascript:void(0)" nc_type="dialog" dialog_title="打印面单用"  uri="index.php?act=store_deliver&op=sanduanma&order_id=
          <?php echo $output['order_info']['order_id'];?>" dialog_width="550" class="ncsc-btn-mini fr"><i class="icon-edit"></i>获取申通三段码</a>
          </td>
        </tr>
		<!--圆通运单推送-->
        <tr>
...
<!--          --><?php //echo $output['order_info']['order_id'];?><!--&op_type=1" dialog_width="550" class="ncsc-btn-mini fr"><i class="icon-edit"></i>测试</a>-->
        ...
        <tr>
          ...
          <!-- <a href="index.php?act=store_deliver&op=DorderPush&order_id=<?php echo $output['order_info']['order_id'];?>&op_type=1"   class="ncsc-btn-mini fr"><i class="icon-edit"></i>订单报文生成（东站）</a>  -->
          <a href="index.php?act=store_deliver&op=DorderPush2&order_id=<?php echo $output['order_info']['order_id'];?>&op_type=1"   class="ncsc-btn-mini fr"><i class="icon-edit"></i>订单报文生成（机场）</a>
        ...
        <tr>
          ...
          <!-- <a href="index.php?act=store_deliver&op=DlistPush&order_id=<?php echo $output['order_info']['order_id'];?>&op_type=1"   class="ncsc-btn-mini fr"><i class="icon-edit"></i>清单报文生成（东站）</a> -->
           <a href="index.php?act=store_deliver&op=DlistPush2&order_id=<?php echo $output['order_info']['order_id'];?>&op_type=1"   class="ncsc-btn-mini fr"><i class="icon-edit"></i>清单报文生成（机场）</a>
...
function deliver_explainsave(){
    var deliver_explain = $("[name='deliver_explain']").val();

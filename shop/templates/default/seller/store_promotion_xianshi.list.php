...
<?php if ($output['isOwnShop']) { ?>
  <a style="margin-right: 90px" class="ncsc-btn ncsc-btn-green" href="<?php echo urlShop('store_promotion_xianshi', 'xianshi_add');?>"><i class="icon-plus-sign"></i><?php echo $lang['xianshi_add'];?></a>
  <a style="display:none" class="ncsc-btn ncsc-btn-green" href="<?php echo urlShop('store_promotion_xianshi', 'xianshi_goods_import');?>"><i class="icon-upload"></i>导入商品</a>
...
<div class="alert alert-block mt10">
  <ul>
    <li>1、点击添加活动按钮可以添加限时秒杀活动，点击管理按钮可以对限时秒杀活动内的商品进行管理</li>
    <li>2、点击删除按钮可以删除限时秒杀活动</li>
 </ul>
</div>
<?php } else { ?>
<div class="alert alert-block mt10">

<div class="eject_con">
    ...
    <form method="post" action="<?php echo urlShop('store_promotion_xianshi_discount', 'xianshi_goods_add_all_save'); ?>" id="plate_form">
...
<!--                                </td>-->
                                ...
                                <td>
                                    <input style="width: 50px" class="text" type="text" name="goods[<?php echo $val['goods_id']; ?>][commis_rate]" nc_type="<?php echo $val['goods_id']; ?>|commis_rate" value="<?php echo $output['commis_rate'];?>">
                                </td>
...
<script>
    ...
    //     $('#plate_form').submit(function () {
            ...
            // formData.shift();
            // formData.shift();
            // var groupedArray = group(formData, 6);
            // var a = 1;

...
<table cellspacing="0" cellpadding="0.5mm" style="table-layout:fixed;">
  <tr>
    <td height="14mm" width="100mm" align="left">111</td>
  </tr>
  <tr>
    <td height="14mm" width="100mm" align="left" colspan="2"><p style="font-size:36pt;text-align:center;">'.$three_code[$i].'</p></td>
  </tr>
  <tr>
  ...
  <tr class="row5">
    ...
    <td HEIGHT="11mm" width="91mm" align="left" >'.$seller_name[$i].'&nbsp;&nbsp;'.$telphone[$i].'<br/>'.$shipper_address[$i].'<br/></td>
  </tr>
  <tr>
    <td style="width: 100mm;height: 19mm;font-size: 0" align="center">
      <img src="'.$site.'/barcode/test.php?codebar=BCGcode128&text='.$logisticsNo[$i].'"  style="width:94mm;height: 14mm;">
    </td>
  </tr>
  <tr class="row7">
    <td style="width: 20mm;height: 19.6mm;float: left;">&nbsp;'.$date1.'<br>&nbsp;'.$date2.'<br>&nbsp;数量:'.$goods_all_num[$i].'<br>&nbsp;重量:'.$goods_total_quantity[$i].'kg</td>
    <td style="width:60mm;height: 19.6mm;">
      <p></p>
      <p style="font-family: Black;font-size: 7pt; text-align: right;">签收栏：&nbsp;&nbsp;&nbsp;&nbsp;</p>
    </td>
    <td style="width:20mm;height:19.6mm;border-right:1px dashed black"><img width="19mm" src="'.$img_adr[$i].'"/></td>
  </tr>
  <tr>
    ...
    <td style="width: 70mm;height: 10mm;border-top: 5px solid black;margin-right: 2mm;font-size: 0">
      <img src="'.$site.'/barcode/test.php?codebar=BCGcode128&text='.$logisticsNo[$i].'" align="right" style="width: 60mm;height: 8mm;">
    </td>
    <td width="2mm" height="10mm" style="border-top: 5px solid black;"></td>
  </tr>
  <tr>
    <td HEIGHT="9mm" width="9mm" align="left" ><p align="right" style="font-size:14pt;">收 </p></td>
    <td HEIGHT="9mm" width="91mm" align="left" >'.$reciver_name[$i].'&nbsp;&nbsp;'.$phone[$i].'<br/>'.$address[$i].'</td>
  </tr>
  <tr>
    <td HEIGHT="9mm" width="9mm" align="left" ><p align="right" style="font-size:14pt;">寄 </p></td>
    <td HEIGHT="9mm" width="91mm" align="left" >'.$seller_name[$i].'&nbsp;&nbsp;'.$telphone[$i].'<br/>'.$shipper_address[$i].'</td>
  </tr>
   <tr class="row13">
  ...
  <tr>
    <td style="width: 100mm;font-size:8pt;height: 11.6mm;align-content: left;column-span: 3;border-top: 5px solid black;" >'.$goods_name[$i].'</td>
  </tr>
  <tr class="row12">

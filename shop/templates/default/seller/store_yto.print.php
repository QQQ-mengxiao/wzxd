...
<table cellspacing="0" cellpadding="0.5mm" style="table-layout:fixed;">
  ...
  <tr>
    <td height="15mm" width="100%" align="left" colspan="2"><p style="font-size:36pt;text-align:center;">'.$three_code[$i].'</p></td>
  </tr>
  <tr>
    <td style="font-size: 0;" width="108mm" height="10mm" align="right"><img src="'.$site.'/barcode/testt.php?codebar=BCGcode128&text='.$centercode[$i].'" style="width: 60mm;height: 10mm; "></td>
  ...
  <tr class="row4">
    ...
    <td width="91%" align="left" style="height:18mm border-bottom:1px solid black;"><p style="font-weight:1500;font-size:'.$size.'pt;font-family:SimHei">'.$reciver_name[$i].'&nbsp;&nbsp;'.$phone[$i].'<br/>'.$address[$i].'</p></td>
  </tr>
  <tr class="row5">
    <td HEIGHT="12mm" width="9%" align="left" ><p align="right" style="font-size:14pt;">寄 </p></td>
    <td HEIGHT="12mm" width="91%" align="left" >'.$seller_name[$i].'&nbsp;&nbsp;'.$telphone[$i].'<br/>'.$shipper_address[$i].'<br/></td>
  </tr>
  <tr>
    <td style="width: 100%;height: 23mm;font-size: 0" align="center">
      <img src="'.$site.'/barcode/test.php?codebar=BCGcode128&text='.$logisticsNo[$i].'"  style="width:90mm;height: 23mm;">
    </td>
  </tr>
  <tr class="row7">
    <td style="width: 22mm;height: 20mm;float: left;">&nbsp;'.$date1.'<br>&nbsp;'.$date2.'<br>&nbsp;数量:'.$goods_all_num[$i].'<br>&nbsp;重量:'.$goods_total_quantity[$i].'kg</td>
    <td style="width:68mm;height: 20mm;">
      <p></p>
      <p style="font-family: Black;font-size: 7pt; text-align: right;">签收栏：&nbsp;&nbsp;&nbsp;&nbsp;</p>
    </td>
    <td style="width:20mm;height:20mm;border-right:1px dashed black"><img width="19mm" src="'.$img_adr[$i].'"/></td>
  </tr>
  <tr>
    ...
    <td style="width: 70mm;height: 10mm;border-top: 5px solid black;margin-right: 2mm;font-size: 0">
      <img src="'.$site.'/barcode/test.php?codebar=BCGcode128&text='.$logisticsNo[$i].'" align="right" style="width: 68mm;height: 14mm;">
    </td>
  ...
  <tr>
    ...
    <td HEIGHT="14mm" width="91%" align="left" >'.$reciver_name[$i].'&nbsp;&nbsp;'.$phone[$i].'<br/>'.$address[$i].'</td>
  </tr>
  <tr>
    <td HEIGHT="12mm" width="9%" align="left" ><p align="right" style="font-size:14pt;">寄 </p></td>
    <td HEIGHT="12mm" width="91%" align="left" >'.$seller_name[$i].'&nbsp;&nbsp;'.$telphone[$i].'<br/>'.$shipper_address[$i].'</td>
  </tr>
  <tr>
    <td style="width: 100%;font-size:8pt;height: 28mm;align-content: left;column-span: 3;border-top: 5px solid black;" >'.$goods_name[$i].'</td>
  </tr>
  <tr class="row12">
    <td width="110mm" height="6mm" align="left" colspan="2"><div class="right" style="font-size: 10pt">订单号:'.$order_sn[$i].'</div></td>
  </tr>
</table>';

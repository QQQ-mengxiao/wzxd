   ...
   <!--  <th colspan="20" style="background-color: white;"> -->
      <span class="ml10"><?php echo $lang['store_show_order_buyer_message'].$lang['nc_colon'];?><em><?php echo $order['extend_order_common']['order_message']; ?></em><!--买家留言-->
              ...
              <span class="ml10"><?php echo "卖家备注".$lang['nc_colon'];?>
                      <textarea id="deliver_explain" name="deliver_explain" cols="10" rows="2" class="w150 tip-t"><?php echo $order['extend_order_common']['deliver_explain'];?></textarea>
                  <input style="display:none;" value="<?php echo $order['order_id']?>" id="order_id"/>
                  <input type="button" value="保存" id="deliver_explainsave" class="ncsc-btn" style="float: right;">
...
$(function(){
    $("#deliver_explainsave").click(function(){
        var deliver_explain = $("#deliver_explain").val();
        //var order_id = <?php //echo $output['order_info']['order_id'];?>//;
        var order_id = $("#order_id").val();//console.log(order_id);return;

...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#div_goods_search_result').on('click', '[nctype="btn_add_buy_deliver_goods"]', function() {
            ...
            $('#dialog_add_buy_deliver_goods').nc_show_dialog({width: 450, title: '添加商品'});
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            // if(!isNaN(xinren_price) && xinren_price > 0 && xinren_price < goods_price) {
                $.post('<?php echo urlShop('store_buy_deliver', 'buy_deliver_goods_add');?>', 
                    {goods_id: goods_id,buy_deliver_id:buy_deliver_id},
                    function(data) {
                        if(data.result) {
...
<div id="div_goods_select" class="div-goods-select" style="display: none;">
    <table class="search-form">
      <tr><th class="w150"><strong>第一步：搜索店内商品</strong></th><td class="w160"><input id="search_goods_name" type="text w150" class="text" name="goods_name" value=""/></td>
        <td class="w70 tc"><a href="javascript:void(0);" id="btn_search_goods" class="ncsc-btn none"/><i class="icon-search"></i>搜索</a></td><td class="w10"></td><td><p class="hint">不输入名称直接搜索将显示店内所有普通商品，特殊商品不能参加。</p></td>
      </tr>
    </table>
...
<table class="ncsc-default-table">
  ...
  <tbody id="buy_deliver_goods_list">
    <tr id="buy_deliver_goods_list_norecord" style="display:none">
      <td class="norecord" colspan="20"><div class="warning-option"><i class="icon-warning-sign"></i><span>操作</span></div></td>
    </tr>
  </tbody>
</table>
<tr>

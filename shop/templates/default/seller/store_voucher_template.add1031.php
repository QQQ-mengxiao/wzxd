	...
	<div class="ncsc-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data">
	    ...
	    <dl>
	      ...
	      <dd>
	      	<input type="text" class="text w70" id="txt_template_enddate" class="ui_timepicker" name="txt_template_enddate" value="" readonly><em class="add-on"><i class="icon-calendar"></i></em>

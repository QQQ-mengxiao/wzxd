  ...
  <div class="top-container">
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        ...
        <dd class="seller-permission">管理权限：<strong><?php echo $_SESSION['seller_group_name']."(".$output['dseller_name'].")";?></strong></dd>
        <dd class="seller-last-login" style=" left: 600px;width: 200px;">最后登录：<strong><?php echo $_SESSION['seller_last_login_time'];?></strong> </dd>
        <dd class="store-name"><?php echo $lang['store_name'].$lang['nc_colon'];?>
        <!-- <a href="<?php echo urlShop('show_store', 'index', array('store_id' => $_SESSION['store_id']), $output['store_info']['store_domain']);?>" > -->
...
<?php } ?>
  ...
  <div class="seller-cont" <?php echo $output['seller_group_id']==46?"style='display:none;'":""?>>
    ...
    <div class="container type-a">
      ...
      <div class="content">
        ...
        <ul>
          ...
          <li><a href="index.php?act=store_order&op=index&state_type=state_send"> <?php echo '待收货';?> <strong id="nc_send"></strong></a></li>
          ...
          <!-- <li><a href="index.php?act=store_return&lock=1"> <?php echo '售后退货';?> <strong id="nc_return"></strong></a></li> -->
           <li><a href="index.php?act=store_return&op=index"> <?php echo '退货';?> <strong id="nc_return"></strong></a></li>
    ...
    <div class="container type-d h500">
      ...
      <div class="content">
        ...
        <dl  style="display: none;" class="tghd">
        ...
        <dl style="display: none;" class="xszk">
        ...
        <dl style="display: none;" class="zhxs">
        ...
        <dl style="display: none;" class="tjzw">

  ...
  foreach($val as $k=>$v){ 
    ...
    $html2=$html2.'
      ...
      <tr align="center">
        ...
        <td height="18px" width="490px"  align="left">'.$goods_name.'</td>
...
$html=$html1.$html2.'
  <tr>
    <td height="36px" width="40px" style="border-top:3px solid black;border-bottom:3px solid black;"></td>
  ...
  <tr>
    ...
    <td height="18px" width="220px">联系电话：0371-55172898</td>
  </tr>
  <tr>
    <td height="18px" width="730px" style="border-bottom:3px solid black;">班列购感谢您的惠顾，期待您再次光临！</td>
  </tr>
  '.$store_printdesc.'
  <img src="'.$store_stamp.'"/>
</table>';

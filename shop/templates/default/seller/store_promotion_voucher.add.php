...
<div class="ncsc-form-default">
  <div class="alert alert-block">
    ...
    <ul>
      <li>订单满额度赠送代金券活动的订单限额不能和已有活动重叠</li>
      <li>选择的代金券为已生成的代金券模板</li>
      <li>每个级别赠送至少需要选择一种</li> </ul>
  </div>
  <form id="add_form" action="index.php?act=store_promotion_voucher&op=mansong_save" method="post">
    ...
    <dl> 
      ...
      <dd>
        ...
        <div class="ncsc-mansong-error"><span id="mansong_price_error" style="display:none;"><i class="icon-exclamation-sign"></i>代金券模板id不能为空且必须为数字</span><span id="mansong_discount_error" style="display:none;"><i class="icon-exclamation-sign"></i>发放的代金券数量为每人领取的数量</span></div>
        ...
        <span class="error-message"></span>
        <p class="hint">代金券模板id和发放数量为必填。<br/>系统最多支持设置十组等级规则。</p>
      </dd>
    </dl>
    <dl>

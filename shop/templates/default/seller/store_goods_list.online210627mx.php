  ...
  <table class="search-form">
    ...
    <tr>
      ...
      <td class="w160"><select name="stc_id" class="w150">
        ...
        <th>商品价格</th>
       <td class="w250"><input type="text" class="text w65" name="d_price" value="<?php echo $_GET['d_price']; ?>"/>&nbsp;——&nbsp;<input type="text" class="text w65" name="h_price" value="<?php echo $_GET['h_price']; ?>"/></td>
      ...
      <td class="tc w70"><label class="submit-border">
          <input type="submit" class="submit" value="<?php echo $lang['nc_search'];?>" />
            ...
            <td class="tc w80"><a class="ncsc-btn ncsc-btn-green" target="_blank"
                                  href="index.php?<?php echo $_SERVER['QUERY_STRING']; ?>&op=export"><span>导出Excel</span></a>
            </td>
              <td class="tc w80"><a class="ncsc-btn ncsc-btn-blue" 
                                  href="index.php?<?php echo $_SERVER['QUERY_STRING']; ?>&op=goods_list1"><span>库存为0</span></a>
            </td>
            <!--  <td class="tc w90"><a class="ncsc-btn ncsc-btn-green" target="_blank"
                                  href="index.php?<?php echo $_SERVER['QUERY_STRING']; ?>&op=export1"><span>开发测试</span></a>
            </td> -->
    </tr>
  </table>
</form>

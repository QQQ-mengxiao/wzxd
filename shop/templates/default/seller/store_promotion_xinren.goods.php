...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#div_goods_search_result').on('click', '[nctype="btn_add_xinren_goods"]', function() {
            ...
            $('#dialog_add_xinren_goods').nc_show_dialog({width: 550, title: '添加商品'});
            $('#dialog_xinren_price').val('');
            $('#dialog_xinren_goods_sort').val('9999');
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            var goods_sort = Number($('#dialog_xinren_goods_sort').val());
            ...
            if(!isNaN(xinren_price) && xinren_price > 0 && xinren_price < goods_price) {
                $.post('<?php echo urlShop('store_promotion_xinren', 'xinren_goods_add');?>', 
                    {goods_id: goods_id, xinren_price: xinren_price,goods_sort:goods_sort},
...
<tr class="bd-line">
    <td><input id="goods_sort" type="text" class="text w40" value="<%=goods_sort%>" onblur="sort('<%=xinren_goods_id%>',$(this).val())" style=" margin-right: 10px;"/></td>
    ...
    <script>
        function sort(xinren_goods_id,value) {
            $.post('<?php echo urlShop('store_promotion_xinren', 'goods_sort');?>',
                {
                    goods_sort: value,
                    xinren_goods_id: xinren_goods_id,
                },

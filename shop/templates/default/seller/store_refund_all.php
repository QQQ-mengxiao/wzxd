   ...
   <div class="title">
    ...
    <div class="alert">
      ...
      <ul>
        ...
        <li>2. 成功完成退款/退货；经过商城审核后，会将退款金额退回原来的<em>“支付账户”</em>中。</li>
      </ul>
    </div>
    <div id="saleRefund" show_id="1">
      ...
      <div class=" ncsc-form-default">
        <div id="warning"></div>
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?act=store_order&op=add_refund_all&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">

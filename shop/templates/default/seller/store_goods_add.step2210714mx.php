    ...
    <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
      ...
      <dl nc_type="spec_dl" class="spec-bg" style="display:none; overflow: visible;">
        ...
        <dd class="spec-dd" style="width:810px;overflow: scroll">
          <table border="0" cellpadding="0" cellspacing="0" class="spec_table" style="width:135%;">
            <thead>
              <?php if(is_array($output['spec_list']) && !empty($output['spec_list'])){?>
              <?php foreach ($output['spec_list'] as $k=>$val){?>
            <th nctype="spec_name_<?php echo $k;?>"><?php if (isset($output['goods']['spec_name'][$k])) { echo $output['goods']['spec_name'][$k];} else {echo $val['sp_name'];}?></th>
              <?php }?>
              <?php }?>
              <th class="w100"><?php echo 销售规格;?></th>
               <th class="w100"><?php echo 销售误差;?></th>
                <th class="w100"><?php echo 最小单位;?></th>
             ...
             <!--jinp170608 多规格添加净重、毛重、件数 配置  S-->
              ...
              <th class="w60"><span class="red">*</span><?php echo 件数 ;?>
                <div class="batch"><i class="icon-edit" title="批量操作"></i>
                  <div class="batch-input" style="display:none;">
                    <h6>批量设置价格：</h6>
                    <a href="javascript:void(0)" class="close">X</a>
...
<script type="text/javascript">
    ...
    function recursionSpec($len,$sign) {
        if($len < $sign){
            ...
            echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][xiao_gui]\" data_type=\"xiao_gui\" nc_type=\"'+spec_bunch+'|xiao_gui\" value=\"\" /></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][wu_gui]\" data_type=\"wu_gui\" nc_type=\"'+spec_bunch+'|wu_gui\" value=\"\" /></td><td><select name=\"spec['+spec_bunch+'][ladder1]\">$ladder1</select></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][costprice]\" data_type=\"costprice\" nc_type=\"'+spec_bunch+'|costprice\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><i class=\"icon-renminbi\"></i></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][weight]\" data_type=\"weight\" nc_type=\"'+spec_bunch+'|weight\" value=\"\" /><em class=\"add-on\"><b>kg</b></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][packages]\" data_type=\"packages\" nc_type=\"'+spec_bunch+'|packages\" value=\"\" /></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\" value=\"\" /></td><td><input class=\"text sku\" style=\"width:150px\" type=\"text\" id=\"spec'+spec_bunch+'\"  name=\"spec['+spec_bunch+'][sku]\" nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td><td><select name=\"spec['+spec_bunch+'][ladder]\">$ladder</select></td></tr>';\n";
            for($i=0; $i< $len; $i++){
                echo "}\n";
            }
        }

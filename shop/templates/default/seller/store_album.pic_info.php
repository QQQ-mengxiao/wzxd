...
<div id="pictureFolder" class="ncsc-picture-folder">
  <dl class="ncsc-album-intro">
    ...
    <dd class="album-info" style="margin-left: 225px"><?php echo $output['class_info']['aclass_des']?>
        <p><span><a style="float: right" class="ncsc-btn ncsc-btn-acidblue" href="index.php?act=store_album&op=download&apic_id=<?php echo $output['pic_info']['apic_id']?>">点击下载</a></span></p></dd>
  </dl>

...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
            <td><?php echo $val['p_ladder_id']; ?></td>
     ...
     <td class="goods-time"><?php echo $val['remark'];?></td>
      <td class="nscs-table-handle"><span><a href="index.php?act=store_ladder_price&op=mansong_detail&mansong_id=<?php echo $val['p_ladder_id'];?>" class="btn-blue"><i class="icon-th-list"></i>
        <p><?php echo $lang['nc_detail'];?></p>
          ...
          <span><a href="index.php?act=store_ladder_price&op=ladder_manage&p_ladder_id=<?php echo $val['p_ladder_id'];?>" class="btn-red"><i class="icon-cogs"></i>
        <p>管理</p>
        </a></span>
          <span><a nctype="btn_mansong_del" data-mansong-id="<?php echo $val['p_ladder_id'];?>" href="javascript:return void(0)" class="btn-red"><i class="icon-trash"></i>

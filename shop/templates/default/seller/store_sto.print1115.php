...
<table cellspacing="0" cellpadding="0.5mm" style="table-layout:fixed;">
  ...
  <tr>
    <td HEIGHT="10mm" width="10mm" align="left" ><p align="right" style="font-size:14pt;">收 </p></td>
    <td HEIGHT="9mm" width="91mm" align="left" >'.$reciver_name[$i].'&nbsp;&nbsp;'.$phone[$i].'<br/>'.$address[$i].'</td>
  </tr>
  <tr>
    <td HEIGHT="10mm" width="10mm" align="left" ><p align="right" style="font-size:14pt;">寄 </p></td>
    <td HEIGHT="10mm" width="90mm" align="left" >'.$seller_name[$i].'&nbsp;&nbsp;'.$telphone[$i].'<br/>'.$shipper_address[$i].'</td>
  </tr>
   <tr class="row13">
  ...
  <tr>
    <td style="width: 100mm;font-size:10pt;height: 10.6mm;align-content: left;column-span: 3;border-top: 1px solid black;" >'.$goods_name[$i].'</td>
  </tr>
  <tr class="row12">

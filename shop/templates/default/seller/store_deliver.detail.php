...
$(function(){
    ...
    $.getJSON('index.php?act=store_deliver&op=get_express&OrderCode=<?php echo $output['order_info']['order_sn']?>&LogisticCode=<?php echo $output['order_info']['shipping_code']?>&ShipperCode=<?php echo $output['e_code'];?>&CustomerName=<?php echo $output['order_info']['extend_order_common']['reciver_info']['mob_phone'];?>',function(data){
		if(data){

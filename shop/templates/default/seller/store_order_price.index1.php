...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="act" value="store_order_price" />
	...
	<tr>
	  ...
	  <!--xinjia-->
	  <th><?php echo $lang['store_show_order_receiver'];?></th>  
	  <td class="w100"><input type="text" class="text w80" name="consignee_name" value="<?php echo $_GET['consignee_name']; ?>" /></td>
...
<span class="fr mr5"> <a href="index.php?act=store_order_print&order_id=<?php echo $order_id;?>" class="ncsc-btn-mini" target="_blank" title="打印发货单"/><i class="icon-print"></i>打印发货单</a></span>
    ...
    <tr>
      <th colspan="20"><span class="ml10"><?php echo $lang['store_show_order_buyer_message'].$lang['nc_colon'];?><em><?php echo $order['extend_order_common']['order_message']; ?></em><!--买家留言-->
        </span> <br />
        <span class="ml10"><?php echo "发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票".$lang['nc_colon'];?><em class="goods-time">

...
<div class="wrapper_search">
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <input type="hidden" name="op" value="class_edit_submit" />
      ...
      <div class="bottom tc">
      <label class="submit-border"><input disabled="disabled" nctype="buttonNextStep" value="提交" type="submit" class="submit"style=" width: 200px;" /></label>
      </div>
    </form>
  </div>
</div>

...
<form method="get" action="index.php" target="_blank">
  ...
  <th>配送方式</th>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
      <td class="w80 tc"><label class="submit-border">
          <input type="submit" class="w80" value="配货商品导出" id="export_order" />
        </label></td>
      <td class="w80 tc">
          <input type="submit" class="green w80" value="配货订单导出" id="export_order2"/>
      </td>
    </tr>
  </table>
</form>

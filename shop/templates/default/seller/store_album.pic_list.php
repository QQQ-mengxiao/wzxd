  ...
  <dl class="ncsc-album-intro">
    ...
    <dd class="album-covers">
      ...
      <?php }?>
        ...
        <dd class="album-info" style="margin-left: 225px"><?php echo $output['class_info']['aclass_des'] ?>
            <p><span><a style="float: right" class="ncsc-btn ncsc-btn-acidblue" href="index.php?act=store_album&op=img_download_all&aclass_id=<?php echo $output['class_info']['aclass_id']?>">下载全部</a></span></p>
            <p><span><a style="float: right;margin-right: 10px" class="ncsc-btn ncsc-btn-acidblue" href="JavaScript:void(0);"
                        id="img_download">点击下载</a></span></p></dd>
  </dl>
...
function submit_form(type){
    ...
    $('#img_download').click(function () {
        ...
        $('#img_download').attr('href','index.php?act=store_album&op=img_download&apic_id='+id);
    });

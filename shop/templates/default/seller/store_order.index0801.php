...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    ...
    <tr>
      ...
      <!--xinzeng 11.1-->
       <th>发货人</th>
    <td class="w100"><input type="text" class="text w80" name="senderusername" value="<?php echo $_GET['senderusername']; ?>" /></td>
    </tr>
	<tr>
  ...
  <tbody>
    ...
    <tr>
      <th colspan="20"><span class="ml10"><?php echo $lang['store_order_order_sn'].$lang['nc_colon'];?><em><?php echo $order['order_sn']; ?></em>
        <?php if ($order['order_from'] != 1){?>
        <i class="icon-mobile-phone"><?php if ($order['order_from'] == 2){
			echo "(wap)";}else if(($order['order_from'] == 3)){echo "(Android)";}else{echo "(IOS)";}?>
        </i>
        <?php }?>

...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="act" value="store_cw_over" />
    <input type="hidden" name="op" value="order_over" />
...
<span class="fr mr5"> <a href="index.php?act=store_order_print&order_id=<?php echo $order_id; ?>" class="ncsc-btn-mini" target="_blank" title="打印发货单"/><i class="icon-print"></i>打印发货单</a></span><!--打印发货单-->
    ...
    <tr>
      ...
      <td class="bdl bdr" rowspan="<?php echo $order['goods_count']; ?>"><p><?php if ($order['refund_state'] == '1') {echo '部分退款';} else if ($order['refund_state'] == '2') {echo '已关闭';} else {echo $order['state_desc'];}?>
        ...
        <!-- 订单查看 -->
        <p><a href="javascript:void(0)" class="ncsc-btn-mini ncsc-btn-blue mt10" uri="index.php?act=store_cw_over&op=cw_over&order_sn=<?php echo $order['order_sn']; ?>" dialog_width="480" dialog_title="补推订单" nc_type="dialog"  dialog_id="store_cw_submit"/><i class="icon-share"></i>补推收货</a></p>

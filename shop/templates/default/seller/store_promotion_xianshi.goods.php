...
<ul>
    <a class="ncsc-btn-mini ncsc-btn-green" onclick="add()" id="add" url="<?php echo urlShop('store_promotion_xianshi', 'xianshi_goods_add_all');?>">批量添加</a>
...
<ul class="goods-list">
  ...
  <li>
    ...
    <a nctype="btn_add_xianshi_goods" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-img="<?php echo thumb($val, 240);?>" data-goods-price="<?php echo $val['goods_price'];?>" data-goods-promotion="<?php echo $val['goods_promotion'];?>" href="javascript:void(0);" class="ncsc-btn-mini">选择商品/修改秒杀价</a> </li>
  <?php } ?>
</ul>
...
<div id="dialog_add_xianshi_goods" style="display:none;">
  ...
  <div class="selected-goods-info">
    ...
    <dl class="goods-info" style="width: 350px">
      ...
      <dd>佣金比例：<input id="dialog_xianshi_commis_rate" type="text" class="text w70" value="<?php echo $output['commis_rate'];?>"><em class="add-on"><i><B>%</B></i></em>
          <label>0为不分佣</label></dd>
      <dd>商品排序：<input id="dialog_xianshi_goods_sort" type="text" class="text w70" value="0">

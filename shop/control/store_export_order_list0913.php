...
class store_export_order_list0913Control extends BaseSellerControl
{
    ...
    public function export_orderOp()
    {
        ...
        // } else {
            $this->excel_order_sub($data,$type,$ziti_name,$sum);
        // }
    }

    private function excel_order_sub($data_tmp,$type,$ziti_name,$sum)
    {
        $excel = new PHPExcel();

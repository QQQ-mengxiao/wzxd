...
class seller_centerControl extends BaseSellerControl {
    ...
    public function indexOp() {
        ...
        if($seller_group_id == 46){
            ...
            $dseller_name = Model()->table('daddress')->getfby_address_id($address_id,'seller_name');
        }
        Tpl::output('seller_group_id',$seller_group_id);
        Tpl::output('dseller_name',$dseller_name);
    ...
    public function statisticsOp() {
        ...
        //待收货
        $no_receipt = $model_order->getOrderCountByID('store',$_SESSION['store_id'],'SendCount');

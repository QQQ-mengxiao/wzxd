...
//        }
    ...
    public function edit_goods_simpleOp() {
        ...
        if (chksubmit()) {
            ...
            if($goods_info){
                        $update = array('goods_serial' => $value['serial'], 'goods_storage' => $value['storage']);
        ...
        $goods_list = $model_goods->getGoodsList(array('goods_commonid' => $common_id), 'goods_spec,goods_storage,goods_serial,goods_id,goods_name');
...
//                            $file_name = $goods_name . iconv('utf-8', 'gbk//IGNORE', $vv);
    ...
    public function storage_synchro_goodsOp()
    {
        ...
        $model_cw = Model('cw');
        $result = $model_cw->cwPlatGoodsSyn(1, $goods_serial_list);
        ...
        if($result_data['code'] == 0){
            ...
            showDialog($result_data['msg'], '', 'error');
        }
    }

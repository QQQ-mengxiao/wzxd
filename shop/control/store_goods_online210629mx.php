...
//        }
    ...
    public function get_goods_list_ajaxOp() {
        ...
        $goods_list = $model_goods->getGoodsList(array('store_id' => $_SESSION['store_id'], 'goods_commonid' => $common_id), 'goods_id,goods_spec,store_id,goods_price,goods_serial,goods_storage_alarm,goods_storage,goods_image,p_ladder_id');
        if (empty($goods_list)) {
            echo 'false';exit();
        }
    ...
    public function edit_goods_simpleOp() {
        ...
        $goods_list = $model_goods->getGoodsList(array('goods_commonid' => $common_id), 'goods_spec,goods_storage,goods_serial,goods_id,goods_name,p_ladder_id');

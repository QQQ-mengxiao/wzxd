...
/**
    ...
    public function memberInfo_exportOp()
    {
        ...
        $field = 'member.member_id,member.member_name,member.ziti_id,member.member_mobile,member.member_time,member.member_old_login_time,member.member_points,member.member_exppoints,member_card.cardno';

...
class searchControl extends BaseHomeControl {
    ...
    public function indexOp() {
		...
		$n=0;
                ...
                if($is_vip_price ==1){
                    $goods_list[$key]['goods_price'] = ncPriceFormat($value['goods_price'] * $discount);
                    $goods_list[$key]['goods_promotion_price'] = ncPriceFormat($value['goods_promotion_price'] * $discount);
                }
            }
        }

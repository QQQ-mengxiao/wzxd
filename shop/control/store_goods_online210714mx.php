...
//        }
    ...
    public function get_goods_list_ajaxOp() {
        ...
        $goods_list = $model_goods->getGoodsList(array('store_id' => $_SESSION['store_id'], 'goods_commonid' => $common_id,'is_deleted'=>0), 'goods_id,goods_spec,store_id,goods_price,goods_serial,goods_storage_alarm,goods_storage,goods_image,is_group_ladder');
        if (empty($goods_list)) {
            echo 'false';exit();
        }

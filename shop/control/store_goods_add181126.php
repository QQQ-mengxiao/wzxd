...
class store_goods_addControl extends BaseSellerControl {
    ...
    public function add_step_twoOp() {
        ...
        // 20181120 新添加 获取商品发布时，一级比例下分销板块
    ...
    public function save_goodsOp() {
        ...
        if (chksubmit()) {
           ...
           // 20181120 新添加 商品发布时可选择的是否参与分销的选项
            $common_array['is_fenxiao']         = intval($_POST['is_fenxiao']);
            ...
            //20181120 新添加 参与分销商品的一级分销比例
            $common_array['goods_fx_percent']   = $common_array['is_fenxiao'] == 1&&!empty($_POST['fenxiao_percent']) ? serialize($_POST['fenxiao_percent']) : 0;  
            //20181120 新添加 参与分销商品的二级分销比例
            $common_array['goods_fx_percent2']   = $common_array['is_fenxiao'] == 1 ? intval($_POST['fenxiao_percent2']) : 0;
        ...
        require_once(BASE_RESOURCE_PATH.DS.'phpqrcode'.DS.'index.php');
                ...
                if (is_array($_POST['spec'])) {
                    foreach ($_POST['spec'] as $value) {
                        ...
                        //20181120 新添加 商品是否参与分销is_fenxiao
                        $goods['is_fenxiao']        = $common_array['is_fenxiao'];
                        ...
                        //20181120 新添加 一级分销比例  
                        if(isset($common_array['goods_fx_percent'])){
                            $goods['goods_fx_percent'] = $common_array['goods_fx_percent'];
                        }

                         //20181120 新添加 二级分销比例
                        $goods['goods_fx_percent2']       = $value['goods_fx_percent2'];
             ...
             // 生成商品二维码
                    ...
                    $goods['goods_fx_percent']        = $common_array['goods_fx_percent'];
                    //20181120 新添加 二级分销比例
                    $goods['goods_fx_percent2']        = $common_array['goods_fx_percent2'];

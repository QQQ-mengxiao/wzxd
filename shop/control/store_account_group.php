...
class store_account_groupControl extends BaseSellerControl {
    ...
    public function group_addOp() {
        ...
        //自提地址
        $ziti_list = Model('ziti_address')->table('ziti_address')->where(array('store_id'=>4))->select();
    ...
    public function group_editOp() {
        ...
        Tpl::output('ziti_limits', explode(',', $seller_group_info['ziti_limits']));
    ...
    public function group_saveOp() {
        ...
        $seller_info['ziti_limits'] = empty($_POST['ziti_limits']) ? '' : implode(',', $_POST['ziti_limits']);

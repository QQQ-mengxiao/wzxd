...
$lang['xianshi_price'] = '购买限时秒杀所需金币数';
$lang['xianshi_explain1'] = '1、点击购买套餐和套餐续费按钮可以购买或续费套餐';
$lang['xianshi_explain2'] = '2、点击添加活动按钮可以添加限时秒杀活动，点击管理按钮可以对限时秒杀活动内的商品进行管理';
$lang['xianshi_explain3'] = '3、点击删除按钮可以删除限时秒杀活动';
$lang['xianshi_manage_goods_explain1'] = '1、限时秒杀商品的时间段不能重叠';
$lang['xianshi_manage_goods_explain2'] = '2、点击添加商品按钮可以搜索并添加参加活动的商品，点击删除按钮可以删除该商品';
$lang['xianshi_price_explain1'] = '购买单位为月(30天)，您可以在所购买的周期内发布限时秒杀活动';
...
$lang['xianshi_title_explain'] = '活动标题是商家对限时秒杀活动的别名操作，请使用例如“新品打折”、“月末折扣”类短语表现，最多可输入10个字符；<br/>非必填选项，留空商品优惠价格前将默认显示“限时秒杀”字样。';
$lang['xianshi_explain_explain'] = '活动描述是商家对限时秒杀活动的补充说明文字，在商品详情页-优惠信息位置显示；<br/>非必填选项，最多可输入30个字符。';
$lang['xianshi_name_error'] = '活动名称不能为空';
$lang['xianshi_quota_quantity_error'] = '数量不能为空，且必须为1-12之间的整数';
$lang['xianshi_quota_add_success'] = '限时秒杀套餐购买成功';
$lang['xianshi_quota_add_fail'] = '限时秒杀套餐购买申请失败';
$lang['xianshi_quota_add_fail_nogold'] = '限时秒杀套餐购买申请失败，您没有足够的金币';
$lang['xianshi_quota_current_error'] = '当前没有可用的限时秒杀套餐，请先购买套餐';
$lang['xianshi_quota_current_error1'] = '您还没有申请购买“限时秒杀”促销活动套餐或促销活动已过期<br/>请购买新的“限时秒杀”促销活动套餐。';
$lang['xianshi_quota_current_error2'] = '您已经购买了限时秒杀套餐';
$lang['xianshi_quota_current_error3'] = '您本期套餐已用完不能再发布新活动';
$lang['xianshi_add_success'] = '限时秒杀活动添加成功，请您选择要参加该活动的商品，并发布该活动';
$lang['xianshi_active_status'] = '活动状态';
$lang['xianshi_add_fail'] = '限时秒杀活动添加失败';
$lang['xianshi_goods_none'] = '您还没有添加活动商品';
$lang['xianshi_goods_add_success'] = '限时秒杀活动商品添加成功';
$lang['xianshi_goods_add_fail'] = '限时秒杀活动商品添加失败';
$lang['xianshi_goods_delete_success'] = '限时秒杀活动商品删除成功';
$lang['xianshi_goods_delete_fail'] = '限时秒杀活动商品删除失败';
$lang['xianshi_goods_cancel_fail'] = '限时秒杀活动商品取消失败';
$lang['xianshi_goods_limit_error'] = '已经超过了活动商品数限制';
$lang['xianshi_goods_is_exist'] = '该商品已经参加了本期限时秒杀，请选择其它商品';
$lang['xianshi_publish_success'] = '限时秒杀活动发布成功';
$lang['xianshi_publish_fail'] = '限时秒杀活动发布失败';
$lang['xianshi_cancel_success'] = '限时秒杀活动取消成功';
$lang['xianshi_cancel_fail'] = '限时秒杀活动取消失败';
...
$lang['xianshi_apply_verify_success_glog_desc'] = '购买限时秒杀活动%s个月，单价%s金币，总共花费%s金币';

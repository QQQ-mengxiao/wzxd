    ...
    public function rukuOp(){
       ...
       /* if($order_info['lock_state'] != 0 ){
        ...
        if ($result){
            ...
            $buyer_info = $model_member->getMemberInfo(array('member_id' => $buyer_id));
            ...
            //$output = $wxSubscribe->sendMessage($touser,$order_sn,$order_id,$seller_name,$buyer_id);
            $output = $wxSubscribe->sendMessage($touser,$order_sn,$order_id,$seller_name,$order_info['wms_sn']);

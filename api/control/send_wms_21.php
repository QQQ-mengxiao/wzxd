...
class send_wms_21Control extends BaseControl
{
    ...
    public function indexOp()
    {
      ...
      // //发送数据
      $this->send_url('http://10.10.11.67:8081/wms-admin/onlineApi/onlineOverDetail',$goods_json);
      $result = $this->send_url('http://10.10.11.67:8081/wms-admin/onlineApi/onlineOrderDetail',$order_json);
      var_dump($result);die;
      die;
    }
    ...
    private function merge_goods()
    {
      ...
      $time_end .= " 11:00:00";    
      $online_sn = strtotime($time_end)-86400;

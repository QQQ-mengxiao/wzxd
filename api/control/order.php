...
class OrderControl extends BaseControl
{
    ...
    public function paymentOp()
    {
        ...
        if ($_GET['card_pay'] == 1) {
            ...
            $buyer_info['gonghao'] = $card_info['memberNum'];
            ...
            $card_info = Model('card_new')->getMemberCardInfobygh($buyer_info['gonghao']);
    ...
    public function paymentTypeOp()
    {
        ...
        if (!empty($cardno)) {
            ...
            if (!empty($card_info)) {
                ...
                $result['new_amount'] = ncPriceFormat($card_info['balance16']);
            }
        }

...
class store_export_wms12Control extends BaseControl
{
    ...
    private function send_orders()
    {
      ...
      $post_data_json = json_encode($post_data,320);
      //var_dump($post_data_json);die;
      $this->send_url('http://wms.zo718.cn:8081/wms-admin/onlineApi/onlineOrderDetail',$post_data_json);
    }
    ...
    private function export_order($address_id,$type)
    {
       $model_goods = Model('goods');
        ...
        $time_start_str = strtotime('-19 hours',$time_end_str);

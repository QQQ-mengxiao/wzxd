...
class store_export_wms13Control extends BaseControl
{
    ...
    //     $time_start_str_1 = strtotime('-15 hours',$time_end_str);//处理开始前一天20:00
    ...
    //                   if(!strstr($value['goods_name'],'【预售'.$time_1) || !strstr($value['goods_name'],'【团购'.$time_1)){
    //                           unset($data[$kk]['extend_order_goods'][$key]);
    //                           continue;
    //                       }
    //                   }elseif(strstr($value['goods_name'],'【预售') || strstr($value['goods_name'],'【团购'))
    //                   {
    //                     if (!strstr($value['goods_name'],'【预售'.$time_1) || !strstr($value['goods_name'],'【团购'.$time_1)) {
    //                       unset($data[$kk]['extend_order_goods'][$key]);
    //                       continue;
    ...
    //                   continue;
    //                 }else{
    //                 if(strstr($value['goods_name'],'【预售') || strstr($value['goods_name'],'【团购')){
    //                   unset($data[$kk]['extend_order_goods'][$key]);
    //                   continue;
    //                 }
    //               }
    ...
    //     $time_start_str_1 = strtotime('-15 hours',$time_end_str);
    //     $condition['order.payment_time'] = array('between', array($time_start_str, $time_end_str));
    //     $data = $model_order->getOrderGoodsExportList($condition,'20000');
    //     $ordergoods_arr=array();
    //     $orders_wms = array();

...
//			$state = $model_refund->editOrderRefund($return);
			 $state = $model_refund->editOrderRefund_jp($return);
			if ($state) {
			    ...
			    $model_yundayin-> _yundayin($refund_order_info['order_sn'],$is_refund = 2);

...
//        }
    ...
    public function red_packet_settingOp(){
        ...
        $red_packet_price_array = $red_packet_setting['red_packet_price_array']?implode(',',$red_packet_setting['red_packet_price_array']):'';
...
//            $red_packet_price_region = explode('-','3.60-9.80');
        ...
        $condition['red_packet_setting'] = serialize($red_packet_setting);

	...
	public function noticeOp(){
		...
		if (chksubmit()){
			...
			if ($error != ''){
				...
				if (empty($memberid_list) && $send_type == 1){
				...
				} else if ($send_type == 'V0'){
					$insert_arr['member_id'] = 'V0';
				} else if ($send_type == 'V1'){
					$insert_arr['member_id'] = 'V1';
				} else if ($send_type == 'V2'){
					$insert_arr['member_id'] = 'V2';
				} else if ($send_type == 'V3'){
					$insert_arr['member_id'] = 'V3';
				}

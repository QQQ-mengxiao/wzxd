    ...
    public function indexOp(){
    	...
    	if($_GET['search_field_value']!=''){
    		switch($_GET['search_field_name']){
                ...
                break;
                 case 'gonghao': 
                     $card_info=$model_card->getMemberCardInfobygh($_GET['search_field_value']);
                    $con1['cardno']=$card_info['Sno'];
                    $member_id=Model()->table('member_card')->where($con1)->find();
                    $con['member_card.member_id']=$member_id['member_id'];
                break;
    		}
    	...
    	foreach($member_list as $k=>$v){
            ...
            // var_dump($card_info['Name']);die;
            $member_list[$k]['Name']=$card_info['Name'];
    	}

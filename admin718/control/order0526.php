...
//xinzeng支付时间 11.2
	...
	private function createExcel($data = array()){
		...
		$excel_data[0][] = array('styleid'=>'s_title','data'=>L('exp_od_count')."(不含税)");
		...
		foreach ((array)$data as $k=>$v){
			...
			$tmp[] = array('data'=>date('Y-m-d H:i:s',$v['payment_time']));//新增支付时间 11.2
			$tmp[] = array('data'=>date('Y-m-d H:i:s',$v['finnshed_time']));//新增订单完成时间 0401

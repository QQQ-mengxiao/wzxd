...
$lang['admin_predeposit_nameid']			    = '用户ID';
...
$lang['admin_predeposit_audited']			    = '更改审核状态';
$lang['admin_fx_cash_audited']			        = '审核通过';
$lang['admin_refuse_fx_cash_audited']		    = '驳回申请';
$lang['admin_predeposit_addtime_to']			= '至';
$lang['admin_predeposit_screen']				= '筛选条件';
$lang['admin_predeposit_paystate']				= '支付状态';
$lang['admin_predeposit_pdstate']			    = '提现状态';
$lang['admin_predeposit_approvestate']		    = '审核状态';
$lang['admin_predeposit_to_be_credited']		= '待入账';
$lang['admin_predeposit_booked']				= '已入账';
$lang['admin_predeposit_failure']				= '已失效';
...
$lang['admin_predeposit_cash_help3']			= '在这里可以点击查看相关用户佣金提现相关信息';
$lang['admin_predeposit_cash_help4']			= '通过导出信息表单可以查看更多数据';
$lang['admin_predeposit_cash_confirm']			= '您确认已将提现金额支付到买家提现账户吗？';
$lang['admin_fx_cash_confirm']			        = '您确认将提现金额支付到买家提现账户吗？(余额提现会直接转入)';
$lang['admin_refuse_fx_cash_confirm']			        = '您确定驳回会员本次提现申请吗？(已审核通过的提现申请无法驳回)';

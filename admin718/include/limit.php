...
$_limit =  array(
	...
	array('name'=>$lang['nc_goods'], 'child'=>array(
		...
		// array('name'=>'频道管理', 'op'=>null, 'act'=>'web_channel'),
		)),
	...
	array('name'=>$lang['nc_member'], 'child'=>array(
	    ...
	    array('name'=>'会员卡管理', 'op'=>null, 'act'=>'vip_card'),
		...
		array('name'=>'一卡通管理','op'=>null,'act'=>'member_card'),
		array('name'=>'充值管理','op'=>null,'act'=>'predeposit'),
		array('name'=>'提现管理','op'=>null,'act'=>'pd_cash_list'),
		array('name'=>'预存款明细','op'=>null,'act'=>'pd_log_list'),
		array('name'=>'调节预存款','op'=>null,'act'=>'predeposit_add'),
		)),
	array('name'=>$lang['nc_trade'], 'child'=>array(
		...
		// array('name'=>'签约消息', 'op'=>null, 'act'=>'signing'),
		)),
  ...
  //       array('name'=>'平台充值卡', 'op'=>null, 'act'=>'rechargecard'),
	...
	// array('name'=>'跨境参数', 'child'=>array(
	// 	array('name'=>'hs设置', 'op'=>null, 'act'=>'kuajing_hs'),
	// 	array('name'=>'平台参数设置', 'op'=>null, 'act'=>'kuajing_platform'),
	// 	array('name'=>'物流企业参数设置', 'op'=>null, 'act'=>'kuajing_logistics'),
	// 	array('name'=>'支付企业参数设置', 'op'=>null, 'act'=>'kuajing_payment'),
	// 	array('name'=>'运输方式设置', 'op'=>null, 'act'=>'kuajing_trans_type'),
	// 	array('name'=>'运输工具设置', 'op'=>null, 'act'=>'kuajing_trans_tool')
	// 	)),
...
if (C('mobile_isuse') !== NULL){
	$_limit[] = array('name'=>'小程序', 'child'=>array(
		...
		array('name'=>'支付设置', 'op'=>NULL, 'act'=>'mb_payment'),
		array('name'=>'小程序页面', 'op'=>NULL, 'act'=>'mb_special1'),
		array('name'=>'我的模块管理', 'op'=>NULL, 'act'=>'mine_setting'),
		array('name'=>'通知栏管理', 'op'=>NULL, 'act'=>'noticeboard'),
		array('name'=>'弹出框管理', 'op'=>NULL, 'act'=>'mb_tanchu'),
		// array('name'=>'轮播图上传', 'op'=>NULL, 'act'=>'fx_carousel'),
		// array('name'=>'帮助中心', 'op'=>NULL, 'act'=>'xd_help')
		));
}

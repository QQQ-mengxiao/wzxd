  ...
  <div class="fixed-bar">
      <div class="item-title">
          ...
          <ul class="tab-base">
              ...
              <li><a href="<?php echo urlAdmin('red_packet', 'tixian_setting');?>"><span><?php echo '余额提现设置';?></span></a></li>
          </ul>
      </div>
  </div>
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
            ...
            <td class="vatop tips">红包金额为随机的所填金额，以','分隔多个金额。<font color=color=#ff0000>(所填值应大于0.1且小数点后不超过两位)</font></td>
        </tr>
		<tr class="noborder">
        ...
        <tr class="noborder">
            ...
            <td class="vatop tips">包括红包拥有者第一次分享的次数，以','分隔次数的区间。<font color=color=#ff0000>(应大于等于3)</font></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
            ...
            <td class="vatop tips">每个用户每天拥有的帮拆次数。<font color=color=#ff0000>(必须为单个固定的值所填值建议大于1)</font></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
            ...
            <td class="vatop tips">今天的系统所发放的红包总数（暂不可编辑）其目前已被领取红包数为<font color=color=#ff0000><?php echo $output['count'];?></font></td>
        </tr>
        <!-- <tr class="noborder">

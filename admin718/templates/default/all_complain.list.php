...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <?php } } ?>
        <!-- <li><a href="JavaScript:void(0);" class="current"><span>所有投诉</span></a></li> -->
      </ul>
    </div>
  </div>
  ...
  <form id="search_form" method="get" name="formSearch">
    ...
    <input type="hidden" id="op" name="op" value="all_complain_list" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns " href="index.php?act=complain&op=all_complain_list" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
  ...
  <div style="text-align:right;"><a class="btns" target="_blank" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&op=export"><span>导出Excel</span></a></div>
  <form method='get' id="list_form" action="index.php?act=complaine&op=all_complain_list">

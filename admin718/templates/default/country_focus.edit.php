...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=country&op=web_config"><span><?php echo '国家馆';?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '顶部图片';?></span></a></li>
  ...
  <div class="homepage-focus" id="homepageFocusTab">
    <ul class="tab-menu">
      <li class="current" form="upload_screen_form"><?php echo '顶部左侧小图';?></li>
      <li form="upload_focus_form"><?php echo '顶部右侧小图';?></li>
    </ul>
    <form id="upload_screen_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=screen_pic" target="upload_pic">
      ...
      <div class="margintop"><a href="JavaScript:void(0);" onclick="$('#upload_screen_form').submit();" class="btn"><span><?php echo $lang['web_config_save'];?></span></a>
        <a href="index.php?act=country_api&op=html_update&web_id=<?php echo $output['code_screen_list']['web_id'];?>" class="btn"><span><?php echo $lang['web_config_web_html'];?></span></a>
        <span class="web-save-succ" style="display:none;"><?php echo $lang['nc_common_save_succ'];?></span>
        </div>
    </form>
    <form id="upload_focus_form" class="tab-content" name="upload_screen_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=focus_pic" target="upload_pic" style="display:none;">
      <input type="hidden" name="form_submit" value="ok" />
...
<script src="<?php echo RESOURCE_SITE_URL;?>/country/country_focus.js"></script>

...
<div class="page">
  ...
  <form id="post_form" method="post" action="index.php?act=refund&op=edit_disagree&refund_id=<?php echo $output['refund']['refund_id']; ?>">
    ...
    <table class="table tb-type2">
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="15" ><a href="JavaScript:void(0);" class="btn" id="submitBtn"><span><?php echo 不同意;?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>

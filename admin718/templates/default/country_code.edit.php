  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=country&op=country_detail_edit&web_id=<?php echo $_GET['web_id'];?>"><span>详情页编辑</span></a></li>
      </ul>
    </div>
  </div>
...
<!--
    ...
    <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="index.php?act=country&op=web_html&web_id=<?php echo $_GET['web_id'];?>" class="btn" id="submitBtn"><span><?php echo $lang['web_config_web_html'];?></span></a></td>
        </tr>
      </tfoot>
  </table>
</div>
      ...
      <ul class="adv dialog-adv-s1">
        ...
        <?php foreach ($output['code_adv']['code_info'] as $key => $val) { ?>
            ...
            <li slide_adv_id="<?php echo $val['pic_id'];?>">
              ...
              <input name="adv[<?php echo $val['pic_id'];?>][pic_url]" value="<?php echo SHOP_SITE_URL.'/index.php?act=country&op=countryDetail&web_id='.$output['code_adv']['web_id'];?>" type="hidden">
...
<div id="upload_banner_dialog" class="upload_banner_dialog" style="display:none;">
  ...
  <form id="upload_banner_form" name="upload_banner_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
...
<script src="<?php echo RESOURCE_SITE_URL;?>/country/country_index.js"></script>

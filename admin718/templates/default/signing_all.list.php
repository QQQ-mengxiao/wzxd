    ...
    <table class="tb-type1 noborder search">
      <tbody>
        ...
        <th><select name="type">
            ...
            <option value="buyer_name" <?php if($_GET['type'] == 'buyer_name'){?>selected<?php }?>>签约人</option>
          </select></th>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <?php if($val['status']==20){ ?>
           <td class="align-center">已处理</td>
           <?php }else {?>
             <td class="align-center"><a href="index.php?act=signing&op=audit&signing_id=<?php echo $val['id']; ?>">待处理</a> </td>
             <?php } ?>
      </tr>
      <?php } ?>
    </tbody>

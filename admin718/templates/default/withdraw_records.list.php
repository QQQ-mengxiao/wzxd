...
<a class="btns" target="_blank" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&op=export">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          ...
          <td  class="align-center nowarp"><?php echo empty($val['apply_time'])?'无':date('Y-m-d H:i:s',substr($val['apply_time'],0,10));?></td>
          <td  class="align-center nowarp"><?php echo empty($val['withdraw_time'])?'无':date('Y-m-d H:i:s',substr($val['withdraw_time'],0,10));?></td>

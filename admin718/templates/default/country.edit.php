...
<div class="page">
  ...
  <form id="web_form" method="post" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
      	<tr class="noborder">
          <td colspan="2" class="required"><label class="validation">国家馆名称:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform" style=" height:48px;">
              ...
              <li class="rose"><em></em><i class="icon-ok"></i>玫瑰红</li>
              <li class="cherry"><em></em><i class="icon-ok"></i>樱桃红</li>
              <li class="olive"><em></em><i class="icon-ok"></i>橄榄绿</li>
              <li class="peacock"><em></em><i class="icon-ok"></i>孔雀绿</li>
              <li class="tropic"><em></em><i class="icon-ok"></i>热带橙</li>
              <li class="straw"><em></em><i class="icon-ok"></i>稻草黄</li>
              <li class="gemstone"><em></em><i class="icon-ok"></i>宝石蓝</li>
              <!--
              <li class=""><em></em><i class="icon-ok"></i><?php echo $lang['web_config_style_default'];?></li>
              -->
            </ul></td>

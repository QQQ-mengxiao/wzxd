  ...
  <form id="post_form" method="post" name="form1">
    ...
    <tbody>
      ...
      <tr class="odd" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%; display: table-row;">
        ...
        <tr>
          <td colspan="2" class="required">小程序APPID: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="hidden" name="config_name" value="appid,AppSecret,mchid,key" />
         ...
         <tr>
          <td colspan="2" class="required">小程序密钥:</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input name="AppSecret" id="AppSecret" value="<?php echo $output['config_array']['AppSecret'];?>" class="txt" type="text"></td>
          <td class="vatop tips">AppSecret(小程序密钥) </td>
        </tr>
        <tr>

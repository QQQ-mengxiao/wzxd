...
<div class="index_block home3">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item"> <img nctype="image" style="width: 150px;height:90px;padding-left: 2px;padding-top: 2px; " src="<?php echo getMbSpecial1ImageUrl($item_value['image']);?>" alt="">
      <?php if($item_edit_flag) { ?>
...
<a nctype="btn_edit_item_image" data-desc="320*140" href="javascript:;" style="right: 62px;"><i class="icon-edit"></i>编辑</a>
  ...
  <?php if($item_edit_flag) { ?>
  <a nctype="btn_add_item_image" class="btn-add" data-desc="320*85" href="javascript:;">添加新内容</a>
  <?php } ?>
</div>

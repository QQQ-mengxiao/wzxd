...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="act" value="pd_cash_list">
      ...
      <tbody>
        <tr>
          ...
          <td colspan="2"><input type="text" id="stime" name="stime" class="txt date" value="<?php echo $_GET['stime'];?>">
            ...
            <th><?php echo '平台确认时间'; ?></th>
            <td colspan="2"><input type="text" id="sptime" name="sptime" class="txt date"
                                   value="<?php echo $_GET['sptime']; ?>">
                <label>~</label>
                <input type="text" id="eptime" name="eptime" class="txt date" value="<?php echo $_GET['eptime']; ?>">
            </td>
        </tr>
        <tr>
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php if($v['payment_code'] != 'zihpay'){?>
              <?php echo $v['pdc_amount'];?>
              <?php }else{?>
                  <?php echo $v['refund_amount'].'('.$v['payment_code'].')';?>
                  <?php }?></td>
        ...
        <td class="w90 align-center">
          ...
          <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']; ?>')){window.location='index.php?act=pd_cash_list&op=pd_cash_del&id=<?php echo $v['pdc_id']; ?>';}else{return false;}"><?php echo $lang['nc_del']; ?></a> 
          <?php } ?><a href="index.php?act=pd_cash_list&op=pd_cash_view&id=<?php echo $v['pdc_id']; ?>" class="edit"><?php echo $lang['nc_view']; ?></a>
          </td>
      </tr>
      <?php } ?>
      <?php }else { ?>

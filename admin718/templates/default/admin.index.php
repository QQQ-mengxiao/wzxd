  ...
  <form method="post" id='form_admin'>
    <input type="hidden" name="form_submit" value="ok" />
      <tr>
          ...
          <td><input type="text" value="<?php echo $output['admin_name'];?>" name="admin_name" class="txt" id="admin_name"></td>
          <td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>" style="margin-top: 1px;">&nbsp;</a>
      </tr>

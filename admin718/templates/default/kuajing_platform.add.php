...
<div class="page">
  ...
  <form id="grade_form" name="grade_form" method="post" action="index.php?act=kuajing_platform&op=add_save" >
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="platform_name" name="platform_name" maxlength="50" class="txt"></td>

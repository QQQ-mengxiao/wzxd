...
<div class="index_block home3">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item"> <img nctype="image" style="width: 160px;height: 40px;" src="<?php echo getMbSpecial1ImageUrl($item_value['image']);?>" alt="">
      <?php if($item_edit_flag) { ?>
...
<a nctype="btn_edit_item_image" data-desc="320*80" href="javascript:;" style="right: 62px;"><i class="icon-edit"></i>编辑</a>

    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="w90 align-center">
          ...
          <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del']; ?>')){window.location='index.php?act=brokerage&op=pd_cash_del&id=<?php echo $v['pdc_id']; ?>';}else{return false;}"><?php echo $lang['nc_del']; ?></a> 
          <?php } ?><a href="index.php?act=brokerage&op=pd_cash_view&id=<?php echo $v['pdc_id']; ?>" class="edit"><?php echo $lang['nc_view']; ?></a>
          </td>
      </tr>
      <?php } ?>
      <?php }else { ?>

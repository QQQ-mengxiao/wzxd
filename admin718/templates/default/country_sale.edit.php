...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=country_api&op=focus_edit"><span><?php echo '焦点区';?></span></a></li>
  ...
  <form id="sale_list_form" method="post" name="form1">
    ...
    <a href="index.php?act=country_api&op=html_update&web_id=<?php echo $output['code_sale_list']['web_id'];?>" class="btn"><span><?php echo $lang['web_config_web_html'];?></span></a>
  </form>
</div>

...
<div class="page">
  ...
  <!-- 列表 -->
  <form id="list_form" method="post" action="index.php?act=voucher&op=templatedel">
    <input type="hidden" id="voucher_t_id" name="voucher_t_id"  value="" />
...
<?php } ?>
            ...
            <?php } ?></td>
            <td class="nowrap align-center"><a href="index.php?act=voucher&op=templateedit&tid=<?php echo $val['voucher_t_id'];?>"><?php echo $lang['nc_edit'];?></a>
            <a href="JavaScript:void(0);" onclick="submit_delete('<?php echo $val['voucher_t_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
function submit_delete(voucher_t_id){//lxs

      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><ul class="nofloat">
              ...
              <li>
                <label><input type="radio" value="V0" name="send_type" />V0会员</label>
              </li>
              <li>
                <label><input type="radio" value="V1" name="send_type" />V1会员</label>
              </li>
              <li>
                <label><input type="radio" value="V2" name="send_type" />V2会员</label>
              </li>
              <li>
                <label><input type="radio" value="V3" name="send_type" />V3会员</label>
              </li>
            </ul>
          </td>

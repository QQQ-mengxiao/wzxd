...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=predeposit_add&op=predeposit_add"  class="current"><span>调节预存款</span></a></li>
      </ul>
    </div>
  </div>
...
function checkmember(){
	...
	$.getJSON("index.php?act=predeposit_add&op=checkmember", {'name':membername}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();

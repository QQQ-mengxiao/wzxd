  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '帮拆记录列表';?></span></a></li>
      </ul>
    </div>
  </div>
  <!--  搜索 -->
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center" width="80"><?php echo '用户';?></th>
          <th class="align-center" width="120"><?php echo '帮拆时间';?></th>
          <th class="align-center" width="80"><?php echo '帮拆金额';?></th>
        </tr>
      </thead>
      <tbody id="treet1">
        <?php if(!empty($output['open_records_list']) && is_array($output['open_records_list'])){ ?>
        <?php foreach($output['open_records_list'] as $k => $val){ ?>
        <tr class="hover">
          <td  class="align-center nowarp"><?php echo $val['open_recordid'];?></td>
          ...
          <td  class="align-center nowarp"><?php echo date('Y-m-d H:i:s',substr($val['open_time'],0,10));?></td>
          <td  class="align-center nowarp"><?php echo $val['amount'];?></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">

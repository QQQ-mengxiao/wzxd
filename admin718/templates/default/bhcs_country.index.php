  ...
  <form id="form_grade" method='post' name="">
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
        <th class="w24">&nbsp;</th>
          <th class="align-center">国家名称</th>
          <th class="align-center">原产国（检）</th>
          <th class="align-center">原产国（关）</th>
      ...
      <tbody>
        ...
        <td><input type="checkbox" name='check_sg_id[]' value="<?php echo $v['sg_id'];?>" class="checkitem"></td>
          <td class="align-center"><?php echo $v['country_name'];?></td>
          <td class="align-center"><?php echo $v['origincountryciq'];?></td>
          <td class="align-center"><?php echo $v['origincountrycus'];?></td>

...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>分销首页</h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '首页轮播图';?>
        </span></a></li>
        <li><a href="index.php?act=fx_become&op=fx_become"><span>分销说明图</span></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li>可以传三张图片，在分销首页头部显示，建议使用750px * 300px</li>

    ...
    <tbody>
      ...
      <tr>
        <td colspan="2"><ul>
			...
			<li><strong>活动类型:</strong><?php echo $output['order_info']['order_type_info'];?></li>
                <?php if($output['order_info']['order_type'] == 1){ ?>
                    <li><strong>提货时间:</strong><?php echo date("Y-m-d H:i:s",$output['order_info']['extend_order_common']['ziti_ladder_time']);?></li>
                <?php } ?>
          </ul></td>
      </tr>
      <tr>
        ...
        <td><table class="table tb-type2 goods ">
            <tbody>
              <tr>
                ...
                <th class="align-center">代金券优惠</th>
              ...
              <tr>
                ...
                <td class="w50pre"><p><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></p><p><?php echo goodsTypeName($goods['goods_type']);?></p></td>
                <td class="w96 align-center"><span class="red_common"><?php echo $lang['currency'].$goods['goods_price'];?></span></td>
                <td class="w96 align-center"><span class="red_common"><?php echo $lang['currency'].$goods['ordergoods_pay_price'];?></span></td>
                 <td class="w96 align-center"><span class="red_common"><?php echo $lang['currency'].ncPriceFormat($goods['voucher_price']);?></span></td>

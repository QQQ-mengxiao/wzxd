...
<div class="page">
  ...
  <form id="grade_form" name="grade_form" method="post" action="index.php?act=kuajing_trans_tool&op=add_save" >
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="tool_name" name="tool_name" maxlength="50" class="txt"></td>
       ...
       <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="code_guan" name="code_guan" maxlength="17" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="code_jian" name="code_jian" maxlength="17"class="txt"></td>
          <td class="vatop tips"></td>
        </tr>

...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>平台参数编辑</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=kuajing_payment&op=index" ><span>管理</span></a></li>
  ...
  <form id="grade_form" name="grade_form" method="post" action="index.php?act=kuajing_payment&op=edit_save">
    <input type="hidden" name="payment_id" value="ok" />
	<input type="hidden" name="payment_id" value="<?php echo $output['result']['payment_id'];?>" />
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="payment_name">支付企业名称:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['result']['payment_name']?>" id="payment_name" name="payment_name" maxlength="50" class="txt"></td>

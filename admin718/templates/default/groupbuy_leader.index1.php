        ...
        <tr>
          ...
          <td>
            <select name="search_state">
              <option <?php if($_GET['search_state']==''){?>selected='selected'<?php }?> value="">全部</option>
              <option <?php if($_GET['search_state']=='0'){?>selected='selected'<?php }?> value="0">待审核</option>
              <option <?php if($_GET['search_state']=='1'){?>selected='selected'<?php }?> value="1">正常营业</option>
              <option <?php if($_GET['search_state']=='2'){?>selected='selected'<?php }?> value="2">歇业</option>
              <option <?php if($_GET['search_state']=='3'){?>selected='selected'<?php }?> value="3">关闭</option>
            </select>
          </td>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center" style="font-weight: 600;"><?php echo $v['open_time_start'].'~'.$v['open_time_end']; ?></td>
          <td class="align-center"><?php echo $v['state']==2?date('Y-m-d H:i:s',$v['xie_time_start']).'~<br>'.date('Y-m-d H:i:s',$v['xie_time_end']):'未歇业'; ?></td>
          ...
          <td class="align-center">
            <?php if($v['state']==0){ ?>
              待审核<?php }else{?>
            <a href="index.php?act=groupbuy_leader&op=ziti_address_info&address_id=<?php echo $v['address_id']; ?>">查看详情</a>
            <?php }?>
          </td>

  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li>买家提交申请，商家同意并经平台确认后，退款金额原路返还给买家（充值卡部分只能退回到充值卡余额）。</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><a href="index.php?act=refund&op=edit&refund_id=<?php echo $val['refund_id']; ?>"> 确认 </a>|<a href="index.php?act=refund&op=edit_disagree&refund_id=<?php echo $val['refund_id']; ?>"> 不同意 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>

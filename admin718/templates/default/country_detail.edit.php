...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="index.php?act=country&op=web_config"><span><?php echo '板块区';?></span></a></li>
        <li><a href="index.php?act=country&op=web_edit&web_id=<?php echo $_GET['web_id'];?>"><span><?php echo $lang['web_config_web_edit'];?></span></a></li>
        <li><a href="index.php?act=country&op=code_edit&web_id=<?php echo $_GET['web_id'];?>"><span><?php echo $lang['web_config_code_edit'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span>详情页编辑</span></a></li>
      </ul>
    </div>
  </div>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li>商品推荐模块”由于页面宽度只能加4个，商品数为8个。</li>
...
<!--
            ...
            <div class="right-country-detail">
    ...
    <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="index.php?act=country&op=web_country_html&web_id=<?php echo $_GET['web_id'];?>" class="btn" id="submitBtn"><span><?php echo $lang['web_config_web_html'];?></span></a></td>
        </tr>
      </tfoot>
  </table>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=upload_pic" target="upload_pic">
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
...
<div id="recommend_pic_dialog" style="display:none;">
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=slide_adv" target="upload_pic">
...
<div id="upload_banner_dialog" class="upload_banner_dialog" style="display:none;">
  ...
  <form id="upload_banner_form" name="upload_banner_form" enctype="multipart/form-data" method="post" action="index.php?act=country_api&op=upload_country_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    ...
    <table class="table tb-type2" id="upload_act_type_pic" <?php if($output['code_banner']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips">建议上传宽1920*高470像素GIF\JPG\PNG格式图片，超出规定范围的图片部分将被自动隐藏。</td>
        </tr>
                <tr>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/country/country_detail_index.js"></script>

  ...
  <form method="post" name="settingForm" id="settingForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <!-- 裂变红包开启 -->
        <!-- <tr class="noborder">
            <td colspan="2" class="required"><label><?php echo "裂变红包";?>:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform onoff"><label for="redpacket_allow_1" class="cb-enable <?php if($output['list_setting']['redpacket_allow'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['open'];?>"><span><?php echo $lang['open'];?></span></label>
                <label for="redpacket_allow_0" class="cb-disable <?php if($output['list_setting']['redpacket_allow'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['close'];?>"><span><?php echo $lang['close'];?></span></label>
                <input type="radio" id="redpacket_allow_1" name="redpacket_allow" value="1" <?php echo $output['list_setting']['redpacket_allow'] ==1?'checked=checked':''; ?>>
                <input type="radio" id="redpacket_allow_0" name="redpacket_allow" value="0" <?php echo $output['list_setting']['redpacket_allow'] ==0?'checked=checked':''; ?>>
            <td class="vatop tips"><?php echo "开启裂变红包功能，用户可通过分享拆分红包";?></td>
        </tr> -->
        <!-- 促销开启 -->
        <tr class="noborder">

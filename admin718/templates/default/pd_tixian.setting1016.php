  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <li><a href="index.php?act=predeposit&op=pd_cash_list"><span>提现管理</span></a></li>
          <li><a href="JavaScript:void(0);" class="current"><span>提现额度设置</span></a></li>
      </ul>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=predeposit&op=tixian_setting_save">

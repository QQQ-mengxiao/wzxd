    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          ...
          <td  class="align-center nowarp"><?php echo $val['red_packet_amount'];?></td>
          <td  class="align-center nowarp"><?php echo $val['amount'];?></td>
          <td  class="align-center nowarp"><?php echo date('Y-m-d H:i:s',$val['start_time']);?></td>
          <td  class="align-center nowarp"><?php echo empty($val['open_time'])?'无':date('Y-m-d H:i:s',$val['open_time']);?></td>
          ...
          <td  class="align-center nowarp"><?php echo $val['member_nums'];?></td>
            <td class="w96 align-center"><a href="index.php?act=red_packet&op=open_records&red_packetid=<?php echo $v['red_packetid'];?>"><?php echo '帮拆记录';?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">

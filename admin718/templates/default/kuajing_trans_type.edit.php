...
<div class="page">
  ...
  <form id="grade_form" name="grade_form" method="post" action="index.php?act=kuajing_trans_type&op=edit_save">
    <input type="hidden" name="trans_type_id" value="ok" />
	<input type="hidden" name="trans_type_id" value="<?php echo $output['result']['trans_type_id'];?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['result']['trans_type_name']?>" id="trans_type_name" name="trans_type_name" maxlength="50" class="txt"></td>

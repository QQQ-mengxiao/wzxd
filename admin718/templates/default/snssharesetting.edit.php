    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><a href="<?php echo $output['edit_arr']['applyurl'];?>" target="_blank" style="color:#fff; font-weight:bold;"><?php echo $lang['shareset_edit_applylike'];?></a></td>
        </tr>
        <tr>

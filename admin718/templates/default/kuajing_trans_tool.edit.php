    ...
    <table class="table tb-type2">
      <tbody>
       ...
       <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['result']['code_guan']?>" id="code_guan" name="code_guan" maxlength="17" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['result']['code_jian']?>" id="code_jian" name="code_jian" maxlength="17"class="txt"></td>
          <td class="vatop tips"></td>
        </tr>

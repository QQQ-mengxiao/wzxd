...
<div class="page">
    ...
    <form id="form_item" action="<?php echo urlAdmin('mb_special1', 'special_item_save');?>" method="post">
        ...
        <table class="table tb-type2 nohover">
            ...
            <tr class="noborder">
                <td style="height: auto; padding: 0;"><div id="item_edit_content" class="mb-item-edit-content">
                        <?php require('mb_special1_item.module_' . $output['item_info']['item_type'] . '.php');?>
                    </div></td>
            </tr>
            </tbody>
            <tfoot>
            <tr class="tfoot">
                <td colspan="2"><a id="btn_save" class="btn" href="javascript:;"><span>保存编辑</span></a>
                    <?php if($output['item_info']['special_id'] > 0) { ?>
                        <a id="btn_back" href="<?php echo urlAdmin('mb_special1', 'special_edit', array('special_id' => $output['item_info']['special_id']));?>" class="btn"><span>返回上一级</span></a>
                    <?php } else { ?>
                        <a id="btn_back" href="<?php echo urlAdmin('mb_special1', 'index_edit');?>" class="btn"><span>返回上一级</span></a>
                    <?php } ?></td>
            </tr>
            </tfoot>
        </table>
         ...
         <!--    <h4 class="dialog-handle-title">图片名称：</h4>
            ...
            <div>
                <select id="dialog_item_image_type" name="" class="vatop">
                    ...
                    <option value="t_url">跳转链接</option>
                    <option value="g_type">商品活动</option>
            ...
            <input id="dialog_item_image_sort" type="text" value="9999" class="txt w200 marginright marginbot vatop">            
        </div>
...
<script id="item_image_template" type="text/html">
    <div nctype="item_image" class="item">
        ...
        <input nctype="image_sort" name="item_data[item][<%=image_name%>][sort]" type="hidden" value="<%=image_sort%>">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var $dialog_item_image_sort = $('#dialog_item_image_sort');
        ...
        $('[nctype="btn_edit_item_image"]').on('click', function() {
            ...
            $current_image_sort = $item_image.find('[nctype="image_sort"]');
            ...
            $('#dialog_item_image_sort').val($current_image_sort.val());
        ...
        $('[nctype="btn_add_item_image"]').on('click', function() {
            ...
            $dialog_item_image_sort.val(9999);
        ...
        function edit_item_image_save() {
            ...
            $current_image_sort.val($('#dialog_item_image_sort').val());
        }
        ...
        function add_item_image_save() {
            ...
            item.image_sort = $('#dialog_item_image_sort').val();
        ...
        function change_image_type_desc(type) {
            ...
            if(type != '') {
                ...
                //desc_array['t_url'] = '会跳转相应页面，输入框填写1,领劵中心，2.会员中心。';
                desc_array['t_url'] = '会跳转相应页面，输入框填写3,邀新送券，4.签到福利。';
                desc_array['url'] = '链接会跳转到指定链接，输入框填写完整的URL。';
                desc_array['g_type'] = '活动编号会跳转到指定的活动列表，1-阶梯价，3-新人专享，4-限时秒杀，5-即买即送，7-新品, 8-限时折扣, 9-邮寄商品';

  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="" for="member_email"><?php echo $lang['member_index_email']?>:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><label for="company_id">所属公司:</label></td>
        </tr>
        <tr>
          <td class="vatop rowform"  colspan="2">
            <select id="company_id" name="company_id">
            <option value="0">--请选择--</option>
            <?php if(!empty($output['company_info']) && is_array($output['company_info'])){ ?>
            <?php foreach($output['company_info'] as $k => $v){ ?>
              <option value="<?php echo $v['company_id'];?>" <?php if ($output['member_array']['company_id'] == $v['company_id']){echo 'selected=selected';}?>><?php echo $v['company_name']; ?></option>

...
<style>
.mb-item-box .goods-list .item{width: 30%;}
</style>
...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item" style="width:30%;max-width:110px">
      <div class="goods-pic" style="width:120px;height:120px;"><img style="max-height:120px;max-width:220px;width:100px;" nctype="goods_image" src="<?php echo cthumb($item_value['goods_image']);?>" alt=""></div>
